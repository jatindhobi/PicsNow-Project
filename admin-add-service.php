<html>
    <head>
        <title>Add Services - Picsnow Photography</title>
    </head>
</html>
<?php
    ...
    <div class="container align-center">
        <div class="row justify-content-md-center">
            <div class="mbr-white col-md-10 col-lg-12">
                <h1 class="mbr-section-title mbr-semibold pb-3 mbr-fonts-style display-1">Add Services</h1>            
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    <?php } ?>
                        ...
                        <label for="email">Service Name</label>
                            <input type="text" name="service_name" class="add_service" >
                        </div> 
                         <div class="form-group frm_grp">
                        ...
                        <div class="form-group"> 
                            <input type='submit' name='service_submit' value='Submit' class="btn btn-primary">
                        </div>  
                        </form>
                    </div>
